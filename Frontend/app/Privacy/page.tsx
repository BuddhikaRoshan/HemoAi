  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-300">This Privacy Policy describes how FinanceFusion collects, uses, and protects your personal information when you use our services.</p>
          <p className="text-gray-300">We are committed to ensuring that your privacy is protected and that we comply with all applicable data protection laws.</p>
        </div>
      )
    },
    {
